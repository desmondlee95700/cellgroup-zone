    ...
    <div ref={container}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 overflow-hidden">
        ...
        <div className="space-y-20">
          {/* Game 1 */}
          <article className="gsap-reveal group">
            <div className="bg-[#18181B] border-4 border-black border-b-0 py-8 px-8 flex flex-col md:flex-row md:items-center justify-between shadow-[8px_0px_0px_#000] group-hover:-translate-y-1 transition-transform">
              <div>
            ...
            <div className="brutal-box brutal-box-hover bg-[#FACC15] p-8 md:p-12 border-b-0 shadow-none hover:shadow-none">
            ...
            {/* Illustration */}
            <div className="bg-white border-4 border-black border-t-0 p-4 brutal-box group-hover:shadow-[12px_12px_0px_#000] transition-shadow duration-300">
          ...
          <article className="gsap-reveal group">
            ...
            <div className="brutal-box brutal-box-hover bg-[#38BDF8] p-8 md:p-12 border-b-0 shadow-none hover:shadow-none">
